    ...
    public partial class NewMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "0da47feb-2582-4c2d-aec4-5602abdb5515", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "354df1c5-5265-40ca-9eb9-a33c03e70b9a", new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@admin.com", true, "Admin", "minator", false, null, "admin@admin.com", "admin", "AQAAAAEAACcQAAAAEMCuGToTaUxP3r4X5KXzxrFdwVU19UOIMXAnaXI7uuH7kPYePiiktgSR9KeOMyY/MQ==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 7, 10, 20, 46, 27, 642, DateTimeKind.Local).AddTicks(8130), null, 100000m, 200000m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "en", "Love Flowers", "love-flowers", "The Love Flower, also known by its scientific name Amorisia caritatis, is a mesmerizing botanical wonder that symbolizes the essence of love and affection.", "Hoa Tinh Yeu" },
                    { 2, 2, "en", "Birthday Flowers", "birthday-flowers", "The Birthday Flower, known scientifically as Festivus celebratus, is a delightful and vibrant botanical treasure that embodies the joy and celebration of a special day.", "Hoa Sinh Nhat" },
                    { 3, 3, "en", "Congratulation Flowers", "congratulation-flowers", "The Congratulation Flower, scientifically known as Florens triumphi, is a magnificent and awe-inspiring bloom that embodies the spirit of celebration, achievement, and triumph.", "Hoa Chuc Mung" },
                    { 4, 4, "en", "Condolence Flowers", "condolence-flowers", "Condolence flowers hold a special place in expressing sympathy and offering solace during times of grief and loss. ", "Hoa chia buon" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Giữa cuộc sống với bao nhiêu khó khăn, căng thẳng và tấp nập, một chút nhẹ nhàng, hồn nhiên của đóa hồng đỏ chắc chắn sẽ mang đến niềm vui khó tả cho một ai đó. Sống chậm lại và yêu thương nhiều hơn, chia sẻ nhiều hơn và quan tâm nhiều hơn, hãy để bó hồng này giúp bạn gửi đi thông điệp đó nhé.", "Hoa hong do detail", "vi", "Hoa Hong Do", 1, "hoa-hong-do", "Hoa hong do", "Hoa hong do" },
                    { 2, "Made from the freshest sunflowers and adorned with branches of white calimero, the flower basket shines brightly and full of life, as lucky as the sun on a summer day. This will be a very suitable gift if you want to make an impression on your partners, colleagues, friends, or the people you love and care about the most.", "sun-flower", "en", "Sunflower", 1, "sun-flower", "sun-flower", "sun-flower" }
                });
